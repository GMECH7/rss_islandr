      ...
      new Promise(function (i, e) {
        ...
        .then(() => new Promise((i, e) => {
          ...
          for (let [r, h] of Object.entries(t.markers))
            h instanceof HTMLImageElement || h.img
              ? t.ctx.drawImage(h.img, h.x, h.y)
              : t._drawText(h, h.x, h.y);
          for (let [d, p] of Object.entries(t.circles)) t._drawCircle(p);
          i();
        })
          // .then(() => {
          //   // Instead of downloading, send the image data to Python
          //   const imageData = t.canvas.toDataURL("image/png");
          //   pywebview.api.receive_image_data(imageData);
